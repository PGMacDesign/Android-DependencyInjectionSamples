...
public class CircleDrawActivityV2 extends FrameLayout {

    private ProgressBar mProgressBar;
    private FloatingActionButton mFab;

    public CircleDrawActivityV2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void resize() {
        ...
        int additionSize = 0;//getResources().getDimensionPixelSize(R.dimen.progress_bar_size);
     ...
     */
    public static class Behavior extends CoordinatorLayout.Behavior<CircleDrawActivityV2> {
        public Behavior() {
            super();
        }
        ...
        @Override
        public boolean layoutDependsOn(CoordinatorLayout parent, CircleDrawActivityV2 child,
                                       View dependency) {
        ...
        public boolean onDependentViewChanged(CoordinatorLayout parent,
                                              CircleDrawActivityV2 child, View dependency) {
